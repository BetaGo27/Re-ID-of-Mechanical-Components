...
class ProposalFilter(object):
    """

    """

    def __init__(self, n_filtered=128, pos_iou_thresh=0.5, pos_ratio=0.25,
                 neg_iou_thresh_h=0.5, neg_iou_thresh_l=0.1
                 ):
        self.n_filtered = n_filtered
        self.pos_iou_thresh = pos_iou_thresh
        self.pos_ratio = pos_ratio
        self.neg_iou_thresh_h = neg_iou_thresh_h
        self.neg_iou_thresh_l = neg_iou_thresh_l
...
class ProposalCreator:
    ...
    def __call__(self, loc, score,
        ...
        roi = roi[keep.cpu().numpy()]  # The final region proposals, which is 20000 by training
        return roi
